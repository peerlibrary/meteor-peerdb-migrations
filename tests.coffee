...
testAsyncMulti 'peerdb-migrations - references', [
  (test, expect) ->
    testDefinition test
...
Tinytest.add 'peerdb-migrations - invalid optional', (test) ->
  test.throws ->
...
Tinytest.add 'peerdb-migrations - invalid nested arrays', (test) ->
  test.throws ->
...
unless CODE_MINIMIZED
  Tinytest.add 'peerdb-migrations - invalid name', (test) ->
    test.throws ->
...
Tinytest.add 'peerdb-migrations - abstract with parent', (test) ->
  test.throws ->
...
testAsyncMulti 'peerdb-migrations - circular changes', [
  (test, expect) ->
...
testAsyncMulti 'peerdb-migrations - recursive two', [
  (test, expect) ->
...
testAsyncMulti 'peerdb-migrations - recursive one', [
  (test, expect) ->
    Recursive.documents.insert
      other: null
      content: 'FooBar'
...
if Meteor.isServer and Document.instances is 1
  Tinytest.add 'peerdb-migrations - errors', (test) ->
...
testAsyncMulti 'peerdb-migrations - delayed defintion', [
  (test, expect) ->
...
testAsyncMulti 'peerdb-migrations - subdocument fields', [
  (test, expect) ->
    Person.documents.insert
      username: 'person1'
      displayName: 'Person 1'
...
testAsyncMulti 'peerdb-migrations - generated fields', [
  (test, expect) ->
    Person.documents.insert
      username: 'person1'
      displayName: 'Person 1'
...
Tinytest.add 'peerdb-migrations - chain of extended classes', (test) ->
...
Tinytest.add 'peerdb-migrations - local collections', (test) ->
  list = _.clone Document.list
...
testAsyncMulti 'peerdb-migrations - errors for generated fields', [
  (test, expect) ->
    Log._intercept 3 if Meteor.isServer and Document.instances is 1 # Three to see if we catch more than expected
...
Tinytest.add 'peerdb-migrations - tricky references', (test) ->
  list = _.clone Document.list
...
testAsyncMulti 'peerdb-migrations - duplicate values in lists', [
  (test, expect) ->
    Person.documents.insert
      username: 'person1'
      displayName: 'Person 1'
...
if Meteor.isServer and Document.instances is 1
  testAsyncMulti 'peerdb-migrations - exception while processing', [
    (test, expect) ->
      Log._intercept 3
...
testAsyncMulti 'peerdb-migrations - instances', [
  (test, expect) ->
    testDefinition test
...
Tinytest.add 'peerdb-migrations - bad instances', (test) ->
...
if Meteor.isServer and not Document.instanceDisabled
  testAsyncMulti 'peerdb-migrations - update all', [
    (test, expect) ->
      testDefinition test
...
testAsyncMulti 'peerdb-migrations - reverse posts', [
  (test, expect) ->
    Person.documents.insert
      username: 'person1'
      displayName: 'Person 1'
...
if Meteor.isServer
  testAsyncMulti 'peerdb-migrations - triggers', [
    (test, expect) ->
      testDefinition test
